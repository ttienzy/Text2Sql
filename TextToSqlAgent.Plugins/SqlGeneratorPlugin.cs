...
public class SqlGeneratorPlugin
{
    ...
    public Task<SqlGenerationResult> GenerateSqlWithContextAsync(
        IntentAnalysis intent,
        ...
        CancellationToken cancellationToken = default)
    {
        return GenerateSqlWithContextAsync(
            intent,
            schemaContext,
            originalQuestion,
            conversationHistory,
    ...
    /// </summary>
    public Task<SqlGenerationResult> GenerateSqlWithContextStreamAsync(
        IntentAnalysis intent,
        RetrievedSchemaContext schemaContext,
        string? originalQuestion = null,
        List<TextToSqlAgent.Infrastructure.Entities.Message>? conversationHistory = null,
        ...
        CancellationToken cancellationToken = default)
    {
        return GenerateSqlWithContextStreamAsync(
            intent,
            schemaContext,
            originalQuestion,
            conversationHistory,
    ...
    /// </summary>
    public Task<string> GenerateSqlWithContextLegacyAsync(
    IntentAnalysis intent,
    RetrievedSchemaContext schemaContext,
    string? originalQuestion = null,
    List<TextToSqlAgent.Infrastructure.Entities.Message>? conversationHistory = null,
    CancellationToken cancellationToken = default)
    {
        return GenerateSqlWithContextLegacyAsync(
            intent,
            schemaContext,
            originalQuestion,
            conversationHistory,
    ...
    CancellationToken cancellationToken = default)
    {
        var result = await GenerateSqlWithContextAsync(
            intent,
            schemaContext,
            originalQuestion,
            conversationHistory,
