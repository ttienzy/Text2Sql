...
DATABASE_CONNECTION_STRING=Server=localhost;Database=YourDB;User Id=user;Password=pass;
QDRANT_URL=http://localhost:6333
```

**Cách 2: Setup wizard tự động**
...
**Cách 4: Cấu hình trong app**
- Dùng command `/config` trong app
...
1. **Secure Store** (cao nhất) - Lưu trong `/config` command
2. **Environment Variables** - Từ .env file hoặc system
3. **appsettings.json** - Configuration mặc định
